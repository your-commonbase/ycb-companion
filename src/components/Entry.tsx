...
const Entry = ({
  ...
  onAddLink = async (_: string, __: string, ___: string) => {},
  aliases = [],
  selectedIndex = -1,
}) => {
  ...
  return (
    <div className="my-4 [&_p]:my-6">
      <div className="w-full rounded-lg border border-gray-200 bg-white p-6 shadow">
        ...
        {(hasYouTubeEmbed ||
          ...
          <button
            ...
            onClick={() => {
              setShowEmbeds(true);
              // remove button
              const button = document.getElementById(`embed-button-${id}`);
        ...
        <div className="my-4 flex w-full grid-cols-2 space-x-2">
          <button
            type="button"
